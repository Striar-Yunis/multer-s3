...
A fork of anacronw/multer-s3 adding additional features. Streaming multer storage engine for AWS S3 re-written in Typescript.

## AWS SDK Versions

4.0.0 releases of multer-s3 use the AWS JavaScript SDK v3. Specifically, it uses the Upload class from [@aws-sdk/lib-storage](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/modules/_aws_sdk_lib_storage.html) which in turn calls the modular [S3Client](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/clients/client-s3/classes/s3client.html).

## Installation

```sh
npm install --save multer-s3-extended
```
